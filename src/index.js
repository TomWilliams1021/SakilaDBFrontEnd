...
class MainPage extends React.Component {
  ...
  render() {
    ...
    if (this.state.categoryDataFromServer.length !== 0) {
      return (
        <div id="siteWrapper">
          <h1 id="siteName">My Favorite Movies Blog</h1>
          <p id="aboutInfo">
            Welcome to My Favorite Movies Blog, on this site you can find
            information on what I consider to be some of the best movies out
            there. The movies are organised by category and can be selected to
            view additional information about them such as starring actors,
            release dates, run-time and more.
          </p>
